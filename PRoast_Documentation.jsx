...
╚══════════════════════════════════════════════════════════╝`}
  ...
  const RoastLevelBadge = ({ level, icon, color }) => (
    <span style={{
      display: 'inline-flex',
      alignItems: 'center',
      gap: '6px',
    ...
    <div style={{
      ...
      <header style={{
        ...
        <nav style={{ display: 'flex', gap: '24px' }}>
          ...
          <a href="#" style={{ color: colors.coral, textDecoration: 'none' }}>[?] Docs</a>
          <a href="#" style={{ color: colors.muted, textDecoration: 'none' }}>[$] Pricing</a>
        </nav>
      </header>
